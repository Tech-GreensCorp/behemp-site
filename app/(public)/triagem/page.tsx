        ...
        <Card className="mx-auto max-w-md border-0 shadow-lg">
          <CardContent className="p-8 text-center">
            ...
            <p className="mt-3 text-muted-foreground">
              Obrigado pelas informações. Nossa equipe analisará suas respostas
              e entrará em contato em até 48h pelo WhatsApp.
            </p>
            <Link href="/">
              <Button className="btn-pill mt-6 bg-primary text-primary-foreground" nativeButton={false}>
                Voltar ao início
              </Button>
            </Link>
          </CardContent>
