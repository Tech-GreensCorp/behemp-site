...
const message = "Olá! Vim pelo site da Be4Hope e gostaria de iniciar meu acolhimento.";

const WHATSAPP_URL = `https://wa.me/5511932047360?text=${encodeURIComponent(message)}`;
