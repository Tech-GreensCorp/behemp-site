  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        description={`${paciente.email}${paciente.medicoNome ? ` · Médico: ${paciente.medicoNome}` : ''}`}
        actions={
          <Button
      ...
      <Tabs defaultValue="dados">
        <TabsList className="w-full justify-start overflow-x-auto">
          ...
          <TabsTrigger value="prescricoes" className="gap-1.5">
            <FileSignature size={14} /> Prescrições
          </TabsTrigger>
        ...
        {/* ── PRESCRIÇÕES ── */}
        <TabsContent value="prescricoes"><TabPrescricoes pacienteId={id} /></TabsContent>
