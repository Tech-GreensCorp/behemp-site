...
/**
 * Página de login com design premium split-screen.
 * Esquerda: branding da plataforma.
 * Direita: formulário do Clerk.
 *
 * forceRedirectUrl aponta para a página client-side /redirect,
 * que lê publicMetadata.role e encaminha para o dashboard correto.
 */
        ...
        <div className="relative z-10 space-y-8">
          <div className="space-y-4">
            ...
            <p className="max-w-sm text-base leading-relaxed text-stone-400">
              Bem-vindo de volta à plataforma Be4Hope. Acesse sua conta para gerenciar
              pacientes, consultas e tratamentos.
            </p>
          </div>
      ...
      <div className="flex w-full flex-col items-center justify-center bg-[#f5f0eb] px-6 py-12 lg:w-1/2">
        ...
        <div className="w-full max-w-md">
          <div className="mb-6 space-y-1">
            <h2 className="text-2xl font-semibold tracking-tight text-stone-900">Acessar conta</h2>
            <p className="text-sm text-stone-500">Entre com suas credenciais para continuar</p>
          </div>

          {/*
           * forceRedirectUrl: redireciona para /redirect após login.
           * /redirect é uma página client-side que lê publicMetadata.role
           * e encaminha para /admin, /medico ou /paciente.
           */}
          <SignIn
