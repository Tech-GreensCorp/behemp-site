...
**11/09/2026 — 838 casos em 28 guardas.** (Eram 199 em 8 na medição de 24/08, quando três
...
| `o-destino-do-paciente-segue-o-que-falta`      | o destino depois do cadastro voltar a sair do **fluxo declarado** em vez do que o paciente **não tem** — quem só precisa da procuração era mandado para o agendamento — **56 casos**                                                                                                                                                                                                                                                                                                               | `pnpm test`                          |
...
| `a-transferencia-nao-sai-sem-consentimento`    | a transferência de cadastro para o parceiro sair sem `PARCEIRO_TRANSFERENCIA_ATIVA=1`, sem a finalidade **específica** consentida, ou sem o texto e a versão viajarem junto — **14 casos**                                                                                                                                                                                                                                                                                                         | `pnpm test`                          |
