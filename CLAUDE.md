...
**15/09/2026 — 1399 casos em 60 guardas.** (Eram 199 em 8 na medição de 24/08, quando três
...
| `as-rotas-sensiveis-tem-limite`                           | uma rota sensível ficar sem limite de requisição, ou o `429` existir e não ser **alcançável** — OWASP API4:2023 — **15 casos**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `pnpm test`                          |
