...
**11/09/2026 — 971 casos em 33 guardas.** (Eram 199 em 8 na medição de 24/08, quando três
...
| `documento-do-parceiro-nao-vira-ssrf`          | a busca do documento do parceiro aceitar host fora da allowlist, seguir redirect, dispensar a resolução de DNS, ou deixar de bloquear faixa privada e link-local (`169.254`, metadata da AWS) — OWASP A10:2021 — **24 casos**                                                                                                                                                                                                                                                                                                                               | `pnpm test`                          |
