...
| `o-health-do-parceiro-nao-vaza`                | o health público da integração passar a devolver **protocolo, `referralId` ou dado de paciente** ("só para ajudar a investigar" é o passo que o transforma em vazamento, e é gradual), vazar a URL da API ou um **pedaço do segredo**, devolver a mensagem crua do erro, perder o limite de requisição, ou passar a exigir sessão — um health que precisa de login é mais uma coisa que não funciona na madrugada — **15 casos**, provados por **9 sabotagens**                                                                                                                              | `pnpm test`                          |
