...
**13/09/2026 — 1201 casos em 51 guardas.** (Eram 199 em 8 na medição de 24/08, quando três
...
| `o-cadastro-retoma-de-onde-parou`                | o cadastro voltar a **recomeçar do zero** quem parou no meio. São dois estados, e cada um tinha o seu beco: `signUp` pendente (que o Clerk guarda e a tela ignorava) e sessão viva com ficha não gravada. Também garante que o Clerk não seja chamado com sessão ativa — o `create` passa e o `attempt` morre com `session_exists`, deixando cadastro pendente, conta inexistente e senha que não serve — **16 casos**, provados por **6 sabotagens**                                                                                                                                                                                                                                                                                       |
...
| `a-revogacao-para-a-fila`                        | o `enviador` voltar a mandar sem **reler** o consentimento. Ele era conferido só ao enfileirar, e entre enfileirar e enviar passam horas — revogar nesse intervalo não impedia o envio. LGPD art. 8º §5º diz "a qualquer momento"; era "até a fila rodar" — **10 casos**, provados por **7 sabotagens**                                                                                                                                                                                                                                                                                                                                                                                                                                     |
