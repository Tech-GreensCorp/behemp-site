...
**14/09/2026 — 1351 casos em 58 guardas.** (Eram 199 em 8 na medição de 24/08, quando três
...
| `o-destino-do-paciente-segue-o-que-falta`        | o destino depois do cadastro voltar a sair do **fluxo declarado** em vez do que o paciente **não tem** — quem só precisa da procuração era mandado para o agendamento — **61 casos**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | `pnpm test`                          |
