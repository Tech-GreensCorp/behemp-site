...
| item                                               | estado                                                                                                                                                                                                                         |
| -------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| migration SQL da tabela                            | ⛔ **gerada, provada contra Postgres 16 e APAGADA** — 22/09/2026. Aguarda o PR #110 entrar em `main` **com a 0045 junto**, senão a numeração colide (dois `0044`). Ver o cabeçalho de `db/schema/medicos-mercadopago-conta.ts` |
